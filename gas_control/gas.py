...
def start(info):
    ...
    with open("/home/guibax/PycharmProjects/Fito/gas_control/gas_data.txt", "r") as csvfiler:
        plots = csv.reader(csvfiler, delimiter='\t')
        date = []
        ars = []
        h2 = []
        he = []
        path1 = '/home/guibax/PycharmProjects/Fito/gas_control/static/images/doubplot.png'
        path2 = '/home/guibax/PycharmProjects/Fito/gas_control/static/images/heplot.png'
